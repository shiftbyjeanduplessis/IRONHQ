...
export default async function CoachAthleteDetailPage({ params }: { params: Promise<{ athleteId: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-4xl p-4 md:p-6">
      ...
      <section id="assignment" className="mb-6 rounded-2xl border bg-white p-4 shadow-sm">
      ...
      <section id="coach-notes" className="mb-6 rounded-2xl border bg-white p-4 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h2 className="text-lg font-semibold text-neutral-900">Coach notes in scope</h2>
            <p className="mt-1 text-sm text-neutral-600">Open follow-ups and resolved notes for this athlete in the current coach scope.</p>
          </div>
          <div className="flex flex-wrap gap-2 text-sm">
            ...
            <Link href="#assignment" className="rounded-xl border border-neutral-300 px-3 py-2 text-neutral-800">Open assignment</Link>
          </div>
        </div>
